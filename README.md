...
Question:
Is outpatient physical therapy covered, and does it require prior authorization?
...
Question:
Is this member currently eligible?
...
Question:
Why was this claim denied and what are the next steps?
...
Question:
Is outpatient PT covered and is this member eligible?
...
This project is intentionally designed as a reference architecture, not just a demo:

Shows how to move from experimentation to production

Demonstrates compliance-aware AI patterns

Highlights where responsibility and authority live

Avoids “LLM does everything” anti-patterns

The core insight is simple:

Scalable agentic AI systems are built by deciding where responsibility belongs, not by pushing more logic into the model.
